...
public class RSSReaderWeb {
    ...
    public static void yahooRSSReader(String city, String state) {
        ...
        try {
            ...
            ArrayList<Forcast> forcasts = myXH.getForcast();

            for (Forcast forcast : forcasts) {
                forcast.setCity(city);
                forcast.setState(state);
                WeatherSQL.WeatherSQL.DBinsert(
                        forcast.getCity(),
                        forcast.getState(),
                        forcast.getCode(),
                        forcast.getDate(),
                        ...
                        forcast.getLow(),
                        forcast.getText());
                System.out.println("WeatherRSS.RSSReaderWeb.parsed info");
                System.out.println(forcast);
            }

            WeatherSQL.WeatherSQL.DBread();
        } catch (Exception e) {
